...
public class CacheConfiguration {
    ...
    public JCacheManagerCustomizer cacheManagerCustomizer() {
        return cm -> {
            ...
            createCache(cm, com.mycompany.myapp.domain.SALA.class.getName());
            createCache(cm, com.mycompany.myapp.domain.DadosPessoais.class.getName());
            createCache(cm, com.mycompany.myapp.domain.PROFESSOR.class.getName());
            createCache(cm, com.mycompany.myapp.domain.PROFESSOR.class.getName() + ".dadosPessoais");
